    ...
    <div className='p-5 ' id="contact">
      ...
      <footer className="w-11/12 mx-auto footer  bg-base-300 items-center p-4 flex flex-col justify-around md:flex-row rounded-b-lg">
        <aside className="grid-flow-col items-center">
          ...
          <p>Sports Sphere © {new Date().getFullYear()} - All right reserved</p>
        </aside>
        <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end justify-center items-center">
          <a href="https://x.com/Mustafizur47742" target="_blank"  className="hover:text-black hover:bg-white p-1 rounded-full text-xl">
          <BsTwitterX />

          </a>
          <a  href="https://www.youtube.com/@rt_mustafizur_rahman/" target="_blank" className="hover:text-[#ff0000]  text-2xl rounded-lg" >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <a  href="https://www.facebook.com/tushar.safi.2024/" target="_blank" className="hover:text-[#0866ff] hover:bg-white p-1 text-lg rounded-full">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
